...
reg   [15:0] sample_group1_reg_239;
wire   [7:0] iqtmp_user_V_fu_258_p1;
reg   [7:0] iqtmp_user_V_reg_491;
...
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter1_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter2_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter3_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter4_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter5_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter6_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter7_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter8_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter9_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter10_reg;
reg   [7:0] iqtmp_user_V_reg_491_pp0_iter11_reg;
wire   [15:0] add_ln28_fu_262_p2;
reg   [15:0] add_ln28_reg_502;
wire   [0:0] icmp_ln28_fu_268_p2;
reg   [0:0] icmp_ln28_reg_507;
wire   [0:0] set_tlast_fu_274_p2;
...
reg   [15:0] ap_phi_mux_sample_group1_phi_fu_243_p6;
wire   [63:0] zext_ln28_fu_253_p1;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] tmp_14_fu_442_p4;
wire   [15:0] tmp_13_fu_432_p4;
wire   [15:0] tmp_12_fu_422_p4;
wire   [15:0] tmp_11_fu_412_p4;
wire   [15:0] tmp_10_fu_402_p4;
wire   [15:0] tmp_1_fu_392_p4;
wire   [15:0] tmp_9_fu_382_p4;
wire   [15:0] tmp_6_fu_372_p4;
wire   [15:0] tmp_3_fu_362_p4;
wire   [15:0] tmp_s_fu_352_p4;
wire   [15:0] tmp_8_fu_342_p4;
wire   [15:0] tmp_7_fu_332_p4;
wire   [15:0] tmp_5_fu_322_p4;
wire   [15:0] tmp_4_fu_312_p4;
wire   [15:0] tmp_2_fu_302_p4;
wire   [15:0] trunc_ln674_2_fu_298_p1;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln28_reg_507 == 1'd0))) begin
        sample_group1_reg_239 <= add_ln28_reg_502;
    end else if (((1'b1 == ap_CS_fsm_state1) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln28_reg_507 == 1'd1)))) begin
        sample_group1_reg_239 <= 16'd0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_214)) begin
        if ((icmp_ln28_reg_507 == 1'd1)) begin
            ap_phi_mux_sample_group1_phi_fu_243_p6 = 16'd0;
        end else if ((icmp_ln28_reg_507 == 1'd0)) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter12 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter11 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter9 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter8 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
        table_r_ce0 = 1'b1;
    end else begin
        table_r_ce0 = 1'b0;
    end
...
assign add_ln28_fu_262_p2 = (ap_phi_mux_sample_group1_phi_fu_243_p6 + 16'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter13 == 1'b1) & ((regslice_both_iqout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_qout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_iout_V_data_V_U_apdone_blk == 1'b1) | (iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0))) | ((ap_enable_reg_pp0_iter12 == 1'b1) & ((iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter13 == 1'b1) & ((regslice_both_iqout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_qout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_iout_V_data_V_U_apdone_blk == 1'b1) | (iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state15_io))) | ((ap_enable_reg_pp0_iter12 == 1'b1) & ((iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state14_io))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter13 == 1'b1) & ((regslice_both_iqout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_qout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_iout_V_data_V_U_apdone_blk == 1'b1) | (iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state15_io))) | ((ap_enable_reg_pp0_iter12 == 1'b1) & ((iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0) | (1'b1 == ap_block_state14_io))));
end
...
always @ (*) begin
    ap_block_state15_pp0_stage0_iter13 = ((regslice_both_iqout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_qout_V_data_V_U_apdone_blk == 1'b1) | (regslice_both_iout_V_data_V_U_apdone_blk == 1'b1) | (iqout_TREADY_int_regslice == 1'b0) | (qout_TREADY_int_regslice == 1'b0) | (iout_TREADY_int_regslice == 1'b0));
end
...
always @ (*) begin
    ap_condition_214 = ((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign icmp_ln28_fu_268_p2 = ((ap_phi_mux_sample_group1_phi_fu_243_p6 == 16'd65535) ? 1'b1 : 1'b0);

assign iout_TDATA_int_regslice = table_r_q0[127:0];

assign iout_TVALID = regslice_both_iout_V_data_V_U_vld_out;

assign iqout_TDATA_int_regslice = {{{{{{{{{{{{{{{{tmp_14_fu_442_p4}, {tmp_13_fu_432_p4}}, {tmp_12_fu_422_p4}}, {tmp_11_fu_412_p4}}, {tmp_10_fu_402_p4}}, {tmp_1_fu_392_p4}}, {tmp_9_fu_382_p4}}, {tmp_6_fu_372_p4}}, {tmp_3_fu_362_p4}}, {tmp_s_fu_352_p4}}, {tmp_8_fu_342_p4}}, {tmp_7_fu_332_p4}}, {tmp_5_fu_322_p4}}, {tmp_4_fu_312_p4}}, {tmp_2_fu_302_p4}}, {trunc_ln674_2_fu_298_p1}};

assign iqout_TVALID = regslice_both_iqout_V_data_V_U_vld_out;

assign iqtmp_user_V_fu_258_p1 = ap_phi_mux_sample_group1_phi_fu_243_p6[7:0];

assign qout_TDATA_int_regslice = {{table_r_q0[255:128]}};

assign qout_TVALID = regslice_both_qout_V_data_V_U_vld_out;

assign set_tlast_fu_274_p2 = ((iqtmp_user_V_reg_491_pp0_iter11_reg == 8'd255) ? 1'b1 : 1'b0);

assign table_r_address0 = zext_ln28_fu_253_p1;

assign tmp_10_fu_402_p4 = {{table_r_q0[223:208]}};

assign tmp_11_fu_412_p4 = {{table_r_q0[111:96]}};

assign tmp_12_fu_422_p4 = {{table_r_q0[239:224]}};

assign tmp_13_fu_432_p4 = {{table_r_q0[127:112]}};

assign tmp_14_fu_442_p4 = {{table_r_q0[255:240]}};

assign tmp_1_fu_392_p4 = {{table_r_q0[95:80]}};

assign tmp_2_fu_302_p4 = {{table_r_q0[143:128]}};

assign tmp_3_fu_362_p4 = {{table_r_q0[191:176]}};

assign tmp_4_fu_312_p4 = {{table_r_q0[31:16]}};

assign tmp_5_fu_322_p4 = {{table_r_q0[159:144]}};

assign tmp_6_fu_372_p4 = {{table_r_q0[79:64]}};

assign tmp_7_fu_332_p4 = {{table_r_q0[47:32]}};

assign tmp_8_fu_342_p4 = {{table_r_q0[175:160]}};

assign tmp_9_fu_382_p4 = {{table_r_q0[207:192]}};

assign tmp_s_fu_352_p4 = {{table_r_q0[63:48]}};

assign trunc_ln674_2_fu_298_p1 = table_r_q0[15:0];

assign zext_ln28_fu_253_p1 = ap_phi_mux_sample_group1_phi_fu_243_p6;
