...
architecture behave of dac_table_axim_control_s_axi is
    ...
    constant ADDR_LENGTH_V_DATA_0        : INTEGER := 16#18#;
    constant ADDR_LENGTH_V_CTRL          : INTEGER := 16#1c#;
    constant ADDR_TLAST_DATA_0           : INTEGER := 16#20#;
    constant ADDR_TLAST_CTRL             : INTEGER := 16#24#;
    constant ADDR_REPLAY_LENGTH_V_DATA_0 : INTEGER := 16#28#;
    constant ADDR_REPLAY_LENGTH_V_CTRL   : INTEGER := 16#2c#;
    constant ADDR_RUN_DATA_0             : INTEGER := 16#30#;
    constant ADDR_RUN_CTRL               : INTEGER := 16#34#;
