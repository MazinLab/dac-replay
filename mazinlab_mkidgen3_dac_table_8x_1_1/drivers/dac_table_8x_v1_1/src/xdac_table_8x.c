...
void XDac_table_8x_Set_a(XDac_table_8x *InstancePtr, u64 Data) {
    ...
    XDac_table_8x_WriteReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_8X_CONTROL_ADDR_A_DATA, (u32)(Data));
    XDac_table_8x_WriteReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_8X_CONTROL_ADDR_A_DATA + 4, (u32)(Data >> 32));
}
...
u64 XDac_table_8x_Get_a(XDac_table_8x *InstancePtr) {
    ...
    Data = XDac_table_8x_ReadReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_8X_CONTROL_ADDR_A_DATA);
    Data += (u64)XDac_table_8x_ReadReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_8X_CONTROL_ADDR_A_DATA + 4) << 32;
    return Data;
}
