...
reg   [0:0] p_run_reg_298_pp0_iter3_reg;
...
reg   [0:0] p_run_reg_298_pp0_iter2_reg;
...
reg   [0:0] trunc_ln29_reg_844_pp0_iter2_reg;
reg   [0:0] trunc_ln29_reg_844_pp0_iter3_reg;
wire   [0:0] set_tlast_fu_341_p2;
reg   [0:0] set_tlast_reg_852;
reg   [0:0] set_tlast_reg_852_pp0_iter1_reg;
reg   [0:0] set_tlast_reg_852_pp0_iter2_reg;
reg   [0:0] set_tlast_reg_852_pp0_iter3_reg;
...
reg   [7:0] iqtmp_user_V_reg_874_pp0_iter2_reg;
reg   [7:0] iqtmp_user_V_reg_874_pp0_iter3_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (trunc_ln29_reg_844_pp0_iter2_reg == 1'd0) & (p_run_reg_298_pp0_iter2_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (p_run_reg_298_pp0_iter2_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (p_run_reg_298_pp0_iter3_reg == 1'd1) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (p_run_reg_298_pp0_iter3_reg == 1'd1) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter4 == 1'b1) & (((iqout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((qout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((p_run_reg_298_pp0_iter3_reg == 1'd1) & (iout_TREADY == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter4 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((iqout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((qout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((p_run_reg_298_pp0_iter3_reg == 1'd1) & (iout_TREADY == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter4 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((iqout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((qout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((p_run_reg_298_pp0_iter3_reg == 1'd1) & (iout_TREADY == 1'b0))));
end
...
always @ (*) begin
    ap_block_state5_io = (((iqout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((qout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((p_run_reg_298_pp0_iter3_reg == 1'd1) & (iout_TREADY == 1'b0)));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter4 = (((iqout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((qout_TREADY == 1'b0) & (p_run_reg_298_pp0_iter3_reg == 1'd1)) | ((p_run_reg_298_pp0_iter3_reg == 1'd1) & (iout_TREADY == 1'b0)));
end

always @ (*) begin
    ap_condition_623 = ((1'b0 == ap_block_pp0_stage0) & (p_run_reg_298 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_628 = ((1'b0 == ap_block_pp0_stage0_11001) & (p_run_reg_298 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign iout_TDATA = ((trunc_ln29_reg_844_pp0_iter3_reg[0:0] == 1'b1) ? i_V_1_fu_582_p4 : i_V_reg_884);

assign iout_TKEEP = 16'd0;

assign iout_TLAST = set_tlast_reg_852_pp0_iter3_reg;

assign iout_TSTRB = 16'd0;

assign iqout_TDATA = ((trunc_ln29_reg_844_pp0_iter3_reg[0:0] == 1'b1) ? p_Result_4_fu_762_p17 : p_Result_3_fu_562_p17);

assign iqout_TKEEP = 32'd0;

assign iqout_TLAST = set_tlast_reg_852_pp0_iter3_reg;

assign iqout_TSTRB = 32'd0;

assign iqout_TUSER = iqtmp_user_V_reg_874_pp0_iter3_reg;
...
assign p_Val2_s_fu_798_p3 = ((trunc_ln29_reg_844_pp0_iter3_reg[0:0] == 1'b1) ? p_Val2_2_fu_218 : iq_for2clocks_V_1_reg_879);
...
assign qout_TDATA = ((trunc_ln29_reg_844_pp0_iter3_reg[0:0] == 1'b1) ? q_V_1_fu_592_p4 : q_V_reg_889);

assign qout_TKEEP = 16'd0;

assign qout_TLAST = set_tlast_reg_852_pp0_iter3_reg;
