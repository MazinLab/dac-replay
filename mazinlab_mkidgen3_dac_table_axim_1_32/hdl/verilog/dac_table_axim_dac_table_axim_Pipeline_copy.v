...
wire   [63:0] zext_ln50_fu_180_p1;
wire  signed [63:0] sext_ln54_fu_170_p1;
reg   [14:0] i_fu_74;
wire    ap_loop_init;
reg   [14:0] ap_sig_allocacmp_i_1;
wire   [14:0] add_ln50_fu_127_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln50_fu_121_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_fu_121_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln50_fu_121_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln50_fu_127_p2 = (ap_sig_allocacmp_i_1 + 15'd1);
...
assign comb2wide_V_address1 = zext_ln50_fu_180_p1;
...
assign icmp_ln50_fu_121_p2 = ((ap_sig_allocacmp_i_1 == 15'd16384) ? 1'b1 : 1'b0);

assign m_axi_gmem_ARADDR = sext_ln54_fu_170_p1;
...
assign sext_ln54_fu_170_p1 = $signed(trunc_ln_reg_212);

assign tmp_1_fu_137_p3 = {{empty_26_fu_133_p1}, {7'd0}};

assign zext_ln50_fu_180_p1 = i_1_reg_204;
