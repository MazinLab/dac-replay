...
void XDac_table_axim_Set_a(XDac_table_axim *InstancePtr, u64 Data) {
    ...
    XDac_table_axim_WriteReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_A_DATA, (u32)(Data));
    XDac_table_axim_WriteReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_A_DATA + 4, (u32)(Data >> 32));
}
...
u64 XDac_table_axim_Get_a(XDac_table_axim *InstancePtr) {
    ...
    Data += (u64)XDac_table_axim_ReadReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_A_DATA + 4) << 32;
    return Data;
}
...
void XDac_table_axim_Set_length_r(XDac_table_axim *InstancePtr, u32 Data) {
    ...
    XDac_table_axim_WriteReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_LENGTH_R_DATA, Data);
}
...
u32 XDac_table_axim_Get_length_r(XDac_table_axim *InstancePtr) {
    ...
    Data = XDac_table_axim_ReadReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_LENGTH_R_DATA);
    return Data;
}
...
void XDac_table_axim_Set_replay_length(XDac_table_axim *InstancePtr, u32 Data) {
    ...
    XDac_table_axim_WriteReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_REPLAY_LENGTH_DATA, Data);
}
...
u32 XDac_table_axim_Get_replay_length(XDac_table_axim *InstancePtr) {
    ...
    Data = XDac_table_axim_ReadReg(InstancePtr->Control_BaseAddress, XDAC_TABLE_AXIM_CONTROL_ADDR_REPLAY_LENGTH_DATA);
    return Data;
}
